...
Links are official or established free references, checked September 2026. Read selectively; a resource is not a checklist.

| Topic | Start here |
|---|---|
| Computer/Linux | [Linux Foundation free training](https://training.linuxfoundation.org/resources/free-courses/), [Linux Journey](https://linuxjourney.com/) |
| Networking | [Cloudflare Learning Center](https://www.cloudflare.com/learning/), [Cisco Networking Academy](https://www.netacad.com/courses/networking) |
| Git | [Pro Git](https://git-scm.com/book/en/v2), [Git reference](https://git-scm.com/docs) |
...
| Monitoring | [Prometheus overview](https://prometheus.io/docs/introduction/overview/), [Grafana docs](https://grafana.com/docs/grafana/latest/) |
| Security | [OWASP Top 10](https://owasp.org/www-project-top-ten/), [OWASP cheatsheets](https://cheatsheetseries.owasp.org/) |

Trusted books: *How Linux Works* (Ward), *TCP/IP Illustrated, Volume 1* (Stevens), and *The Linux Command Line* (Shotts; free online). Use current editions where available.
